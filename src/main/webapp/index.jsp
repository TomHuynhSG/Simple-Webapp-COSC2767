...
<html lang="en">
  <head>
    ...
    <title>Hello DevOps Students of RMIT Vietnam!234</title>
  </head>
  <body>
    ...
    <div class="jumbotron">
      <h1 class="display-4">
        ...
        is Tri. I am so glad to be here. Hello!123456
      </h1>
      <p class="lead">
      ...
      <p class="lead">
        This website is build automatically by Jenkins!!! Yeahhhh!!!
      </p>
      <hr class="my-4" />
      <p>
        You can visit the website of School of Science, Engineering and
        Technology (SSET) of RMIT Vietnam by clicking to the button below!
      </p>
      <p>
      ...
      (IOException e) { // Basic error handling e.printStackTrace(); } %>
      <p style="color: green">
